...
// attachment 菜单 alex-1
_e(function (E, $) {

    E.createMenu(function (check) {
        var menuId = 'attachment';
        if (!check(menuId)) {
            return;
        }
        var editor = this;
        ...
        var menu = new E.Menu({
            ...
            id: menuId,
            title: '附件',
            $domNormal: $('<a href="#" class="alexAttachment" tabindex="-1"><i class="wangeditor-menu-img-play"></i></a>'),
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        // -------- 定义load函数 --------
        fns.onload || (fns.onload = function (resultText, xhr, isAttachment) {
            ...
            if (resultText.indexOf('error|') === 0) {
                ...
                //alex-6: render page
                if (!!isAttachment) {
                    var html = '&nbsp;<a href="' + resultText + '">' + originalName + '</a>';
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        // -- build uploader for attachment by alex-2: plugin
        var upfileAttach = new E.UploadFile({
            editor: editor,
            uploadUrl: config.uploadAttachUrl || '/images/attachment' ,
            timeout: uploadTimeout,
            isAttachment: 1 
        });
...
_e(function (E, $) {
    ...
    var UploadFile = function (opt) {
        ...
        //alex-3
        this.isAttachment = opt.isAttachment ;
    };
    ...
    UploadFile.fn.upload = function (file) {
        ...
        reader.onload = function (e) {
            ...
            editor.xhrUploadImg({
                event: e,
                uploadUrl: self.uploadUrl, //alex-4: send params
                filename: filename,
                base64: base64,
                fileType: fileType,
                name: uploadFileName,
                loadfn: function (resultText, xhr) {
                    ...
                    var editor = this;
                    //alex-4: send params
                    onload.call(editor, resultText, xhr, self.isAttachment );
                },
